@xray-test-plan=GFENG-44108 @xray-test-plan=GFENG-43264
...
@android @ios @xray-test-case=GFENG-43270
...
@ios @xray-test-case=GFENG-45537 @xray-test-case=GFENG-43270
Examples: 
  | platform |
  | ios      |

@android @xray-test-case=GFENG-45537 @xray-test-case=GFENG-43270
Examples: 
  | platform            |
  | android             |
